...
urlpatterns = [
    ...
    path('profile/mailing-<int:pk>/create-letter', LetterCreateViewWithConfigMailingDetailView.as_view(), name='create_letter'),
    ...
    path('profile/update-mailing-<int:pk>/update-monthdates', MonthdateUpdateConfigMailingDetailView.as_view(), name='update_monthdate'),
