...
urlpatterns = [
    ...
    path('my-mailings/mayling-<int:pk>/change-password-email/', UpdatePasswordConfigMailingDetailView.as_view(), name='change_password_email'),
    ...
    path('my-mailings/mailing-<int:mailing_pk>/letter-<int:letter_pk>/', LetterMailingDetailView.as_view(), name='letter_detail'),
    path('my-mailings/mailing-<int:pk>/create-letter/', CreateLetterMailingDetailView.as_view(), name='create_letter'),
